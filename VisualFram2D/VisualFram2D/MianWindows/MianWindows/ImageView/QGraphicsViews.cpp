...
QGraphicsViews::QGraphicsViews(const int& index /*=0*/, QWidget* parent /*= nullptr*/)
{
    Initial();
    this->screenIndex = index;
}

void QGraphicsViews::Initial()
{
...
{	
	std::unique_lock<std::mutex> lock(mutexImageShow);
