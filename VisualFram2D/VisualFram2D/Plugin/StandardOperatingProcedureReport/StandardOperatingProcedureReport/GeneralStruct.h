...
public:
	...
	VMVector() :VMObject(QtNodes::NodeDataType{ "6","Vector" }, VMDATATYPE::VM_VECTOR) { ; }
    VMVector(const VMVector& vector_) :VMObject(QtNodes::NodeDataType{ "6","Vector" }, VMDATATYPE::VM_VECTOR) { this->vmVector = vector_.vmVector; }
    VMVector(const std::vector<T> & vector_) :VMObject(QtNodes::NodeDataType{ "6","Vector" }, VMDATATYPE::VM_VECTOR) { this->vmVector =vector_; }
