...
#include "ui_FramExternalDeviceWrite.h"
...
class FramExternalDeviceWrite : public ToolInterface, private ToolPublicFunction
{
    Q_OBJECT

public:
    FramExternalDeviceWrite(QWidget *parent = nullptr);
    ~FramExternalDeviceWrite();
...
private:
    Ui::FramExternalDeviceWriteClass ui;
};
