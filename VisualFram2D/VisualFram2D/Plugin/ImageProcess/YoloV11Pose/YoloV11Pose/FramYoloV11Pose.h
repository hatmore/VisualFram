...
#include "YoloV11Src/config.h"

class FramYoloV11Pose : public ToolInterface, private PublicFunction
{
    Q_OBJECT

public:
    FramYoloV11Pose(QWidget *parent = nullptr);
    ~FramYoloV11Pose();
...
private:
    ...
    //算法实现
    YoloV11PoseAlgorithm::Ptr ptrYoloV11PoseAlgorithm;
