...
IPAddress::IPAddress(QWidget* parent) : QWidget(parent)
{
	...
	labDot1->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei; border-width: 0px");
	labDot1->setAlignment(Qt::AlignCenter);
	labDot1->setText(".");
	labDot2 = new QLabel;
	labDot2->setObjectName("qlabDot2");
	labDot2->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei; border-width: 0px");
	labDot2->setAlignment(Qt::AlignCenter);
	labDot2->setText(".");
	labDot3 = new QLabel;
	labDot3->setObjectName("qlabDot3");
	labDot3->setStyleSheet("color: rgb(0, 0, 200);font: 10pt Microsoft YaHei; border-width: 0px/");
