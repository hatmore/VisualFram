...
class FramPoseC3D : public ToolInterface, private PublicFunction
{
    Q_OBJECT

public:
    FramPoseC3D(QWidget *parent = nullptr);
    ~FramPoseC3D();
...
private:
    //输入节点数据
    PtrVMUnorderedMap<int, PtrVMPolygon> ptrInVMUnorderedMap{ nullptr };
    BaseNodeData::Ptr ptrInNodeVMUnorderedMap;
...
private:
    ...
    //算法实现
    PoseC3DAlgorithm::Ptr ptrPoseC3DAlgorithm;
