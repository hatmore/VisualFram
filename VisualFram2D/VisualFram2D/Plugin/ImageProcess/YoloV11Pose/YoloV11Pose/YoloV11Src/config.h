...
const static int kNumBoxElement = 7 + kNumKpt * kKptDims;  // left, top, right, bottom, confidence, class, keepflag(whether drop when NMS), 51 keypoints

const std::string onnxFile = "E:\\PengSiyao\\Programs\\Yolov11_pose\\Yolov11_pose\\onnx_model\\yolo11s-pose.onnx";
